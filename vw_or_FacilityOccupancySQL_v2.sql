CREATE
OR REPLACE VIEW qlik.vw_or_FacilityOccupancySQL_v2 AS
SELECT
    a.EntityID,
    a.EntityCode,
    a.EntityName,
                ...
                from
                    (
                        select
                            ...
                            e.entitycode,
                            f.facilityid,
                            "resident days" as residentdays,
                            "in service days" as inservicedays
                        from
                            (
                                select
                                    case
                                    ...
                                    m.*
                                from
                                    "acm_sharepoint_db"."tblmonthlyoccupancy" as m
